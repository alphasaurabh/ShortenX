...
1.  **Clone the repository**
    ```bash
    git clone [https://github.com/alphasaurabh/ShortenX.git](https://github.com/alphasaurabh/ShortenX.git)
    cd ShortenX
    ```
...
##Here is the complete README.md code in a single block, ready to copy.
